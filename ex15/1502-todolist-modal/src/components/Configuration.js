    ...
    <div>
      <header className="bg-green-400 text-white p-4">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold leading-none">할 일 전체 보기</h1>
          <Button pill className="bg-teal-500" onClick={() => navigate("/")}>
      ...
      <footer className="bg-green-300 text-white p-4 text-center">
